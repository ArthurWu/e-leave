...
class RegexPicker(Plugin):
	...
	def options(self, parser, env):
		...
		parser.add_option("--re-pattern",
			dest = "pattern",
			action = "store",
			default = env.get("NOSE_REGEX_PATTERN", "text.*"),
			help = ("Run test mothods that have a method name matching this regular expression")
		)
...
if __name__ == "__main__":
    args = ["", "test_employee", "--with-regexpicker", \

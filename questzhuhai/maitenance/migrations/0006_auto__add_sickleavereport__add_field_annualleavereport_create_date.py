...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SickLeaveReport'
        db.create_table('maitenance_sickleavereport', (
            ...
            ('sl_entitlement_of', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ...
        db.send_create_signal('maitenance', ['SickLeaveReport'])

        # Adding field 'AnnualLeaveReport.create_date'
        db.add_column('maitenance_annualleavereport', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 9, 7, 14, 12), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SickLeaveReport'
        db.delete_table('maitenance_sickleavereport')

        # Deleting field 'AnnualLeaveReport.create_date'
        db.delete_column('maitenance_annualleavereport', 'create_date')

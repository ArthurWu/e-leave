...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnnualLeaveReport'
        db.create_table('maitenance_annualleavereport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maitenance.Employee'])),
            ('working_days', self.gf('django.db.models.fields.FloatField')()),
            ('al_entitlement_of', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('total_entitled_as_of', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('report_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('jan_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('feb_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('mar_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('apr_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('may_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('jun_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('jul_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('aug_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('sep_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('oct_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('nov_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('dec_taken', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('Taken_in_this_year', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('jan_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('feb_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('mar_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('apr_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('may_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('jun_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('jul_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('aug_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('sep_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('oct_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('nov_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('dec_deduction', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('Available_annual_leave_unclaimed', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('Application_comp_leave', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('taken_comp_leave', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('balance_of_comp_leave', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('marrige_leave_balance', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        db.send_create_signal('maitenance', ['AnnualLeaveReport'])


    def backwards(self, orm):
        
        # Deleting model 'AnnualLeaveReport'
        db.delete_table('maitenance_annualleavereport')
